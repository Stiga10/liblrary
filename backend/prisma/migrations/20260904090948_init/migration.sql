...
CREATE TABLE `Reader` (
    ...
    UNIQUE INDEX `Reader_cardNumber_key`(`cardNumber`),
    INDEX `Reader_fullName_idx`(`fullName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Loan` (
    ...
    INDEX `Loan_readerId_status_idx`(`readerId`, `status`),
    INDEX `Loan_status_dueDate_idx`(`status`, `dueDate`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
